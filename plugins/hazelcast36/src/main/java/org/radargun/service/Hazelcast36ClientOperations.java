...
public class Hazelcast36ClientOperations implements BasicOperations {

    private final Hazelcast36ClientService service;

    public Hazelcast36ClientOperations(Hazelcast36ClientService service) {
